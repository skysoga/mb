...
var sscConfig = {
  "五星": {
    ...
    "趣味": [{
      ...
      "name": "好事成双",
      "mode": "H42",
      "tip": "从0-9中至少选择1个号码投注，竞猜开奖号码中包含这个号码且出现2次，即中奖。",
      "group": "五星",
      "subGroup": "趣味",
      "tag": "五星好事成双",
      "eg": ["8", "xxx88（不限顺序）"]
      ...
      "name": "三星报喜",
      "mode": "H43",
      "tip": "从0-9中至少选择1个号码投注，竞猜开奖号码中包含这个号码且出现3次，即中奖。",
      "group": "五星",
      "subGroup": "趣味",
      "tag": "五星三星报喜",
      "eg": ["8", "xx888（不限顺序）"]
      ...
      "name": "四季发财",
      "mode": "H44",
      "tip": "从0-9中至少选择1个号码投注，竞猜开奖号码中包含这个号码且出现4次，即中奖。",
      "group": "五星",
      "subGroup": "趣味",
      "tag": "五星四季发财",
      "eg": ["8", "x8888（不限顺序）"]
  ...
  "前三": {
    ...
    "组选": [{
      ...
      "name": "组三",
      "mode": "F22",
      "tip": "从0-9中选择2个数字组成两注，所选号码与开奖号码的前三位相同，顺序不限。",
      "group": "前三",
      "subGroup": "组选",
      "tag": "前三组选组三",
      "eg": ["112**", "112**（不限顺序）"]
      ...
      "name": "组六",
      "mode": "F23",
      "tip": "从0-9中任意选择3个号码组成一注，所选号码与开奖号码的前三位相同，顺序不限。",
      "group": "前三",
      "subGroup": "组选",
      "tag": "前三组选组六",
      "eg": ["123**", "123**（不限顺序）"]
  ...
  "中三": {
    ...
    "组选": [{
      ...
      "name": "组三",
      "mode": "E22",
      "tip": "从0-9中选择2个数字组成两注，所选号码与开奖号码的中三位相同，且顺序不限，即中奖。",
      "group": "中三",
      "subGroup": "组选",
      "tag": "中三组选组三",
      ...
      "name": "组六",
      "mode": "E23",
      "tip": "从0-9中任意选择3个号码组成一注，所选号码与开奖号码的中三位相同，顺序不限。",
      "group": "中三",
      "subGroup": "组选",
      "tag": "中三组选组六",
      "eg": ["*123*", "*123*（不限顺序）"]
  ...
  "后三": {
    ...
    "组选": [{
      ...
      "name": "组三",
      "mode": "D22",
      "tip": "从0-9中选择2个数字组成两注，所选号码与开奖号码的后三位相同，且顺序不限。",
      "group": "后三",
      "subGroup": "组选",
      "tag": "后三组选组三",
      "eg": ["**112（1为二重号，2为单号）", "**112（不限顺序）"]
      ...
      "name": "组六",
      "mode": "D23",
      "tip": "从0-9中任意选择3个号码组成一注，所选号码与开奖号码的后三位相同，顺序不限。",
      "group": "后三",
      "subGroup": "组选",
      "tag": "后三组选组六",
      "eg": ["**123", "**123（不限顺序）"]
