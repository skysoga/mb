            ...
            <template v-if="isBetPage">
              ...
              <template v-else>
                ...
                <!-- <div class="msg noMore" v-html="msg[temp_ajax[newName+'%'+newDay][x-1].cant_scroll]" v-if="temp_ajax[newName+'%'+newDay][x-1].cant_scroll<2"></div>
                  ...
                  <div class="msg noMore" v-if="temp_ajax[newName+'%'+newDay][x-1].cant_scroll===1">
                  ...
                  <div class="msg noMore" v-if="temp_ajax[newName+'%'+newDay][x-1].cant_scroll===2" v-html="msg[temp_ajax[newName+'%'+newDay][x-1].cant_scroll][newDay]"></div>
                  <div class="msg noMore" v-if="temp_ajax[newName+'%'+newDay][x-1].cant_scroll===0" v-html="msg[temp_ajax[newName+'%'+newDay][x-1].cant_scroll]"></div>
              </template>
            </template>
            <!-- 投注模板页面 -->
            <!-- 交易模板页面 -->
