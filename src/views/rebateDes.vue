<template>
  <div class="main rebateDes" style="padding-bottom:0">
    <div class="testShow" v-show="ArrObj&&BetweenType!='K3'&&BetweenType!='LHC'" style="padding:5px"><i class="iconfont">&#xe624;</i>{{BottomBoxList[BetweenType]}}是基数2元1注的奖金模式,奖金÷2换算成赔率。</div>
...
<script src="../js/rebateDes.js"></script>
