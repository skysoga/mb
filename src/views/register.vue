    ...
    <tbody>
      ...
      <tr>
        ...
        <td colspan="2" class="username passwordICO">
          <input v-if="Eyes=='close'" type="password" class="input fl mL15" maxlength="16" v-va:Password.clear tag="设置密码" v-model="Password" placeholder="请输入您要设置的密码" />
          <input v-if="Eyes=='open'" type="text" class="input fl mL15" maxlength="16" v-va:Password.clear tag="设置密码" v-model="Password" placeholder="请输入您要设置的密码" />
